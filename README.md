# Hex Template — Gorilla Tag BepInEx Plugin Template
 ...
 A clean, minimal BepInEx plugin template for Gorilla Tag.
No menus, no bloat — just the essentials so you can build from scratch.

# Why this template?
***Most*** templates come with full menus pre-built, which doesn't help you learn.
This gives you the foundation without making decisions for you.
